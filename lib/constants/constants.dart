class Constants {
  ...
  static const anilistMediaQuery =
      'query Media(\$id: Int!) { Media(id: \$id) { title { native } synonyms averageScore status(version: 2) bannerImage format description genres format seasonYear startDate { year } trailer { id site thumbnail } characters(perPage: 6) { pageInfo { hasNextPage } edges { role node { id name { userPreferred } image { medium } } } } relations { pageInfo { hasNextPage } edges { relationType(version: 2) node { id } } } } }';
}
